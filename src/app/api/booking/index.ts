...
const appointments = [
  ...
  { date: '2023-11-27', time: '10:30', personId: 3 },
  // Weitere Termine...
];
...
const openingTimes = {
  ...
  5: { openingHour: 10, closingHour: 17 }, // Freitag
  6: { openingHour: 9, closingHour: 17 }, // Samstag
  0: { openingHour: 0, closingHour: 0 }, // Sonntag
};

export const calculateAvailableTimeSlots = (dateString: string) => {
  ...
  for (
    ...
    slots.push({
      time: utcToZonedTime(i, timeZone),
      available: 3,
      bookedPersons: [],
    });
  }
